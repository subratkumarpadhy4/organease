...
const Product = () => {
  ...
  if (loading) {
    return (
      <div className="col-span-1 flex items-center justify-center py-24">
        <svg
              ...
              >
                <div className="md:w-1/2 md:flex md:items-center">
                  <img
                    ...
                    src={product.pImages[0] && product.pImages[0].startsWith("data:") ? product.pImages[0] : `${apiURL}/uploads/products/${product.pImages[0]}`}
                    alt="wishListproduct"
                  />
