...
const EditProductModal = (props) => {
  ...
  const submitForm = async (e) => {
    ...
    if (editformData.pEditImages) {
      b64Images = [];
      for (const file of editformData.pEditImages) {
    ...
    let payload = { ...editformData, pEditImages: b64Images };

    try {
      let responseData = await editProduct(payload);
              ...
              {editformData.pImages ? (
                <div className="flex space-x-1">
                  <img
                    ...
                    src={editformData.pImages[0] && editformData.pImages[0].startsWith("data:") ? editformData.pImages[0] : `${apiURL}/uploads/products/${editformData.pImages[0]}`}
                    alt="productImage"
                  />
                  <img
                    className="h-16 w-16 object-cover"
                    src={editformData.pImages[1] && editformData.pImages[1].startsWith("data:") ? editformData.pImages[1] : `${apiURL}/uploads/products/${editformData.pImages[1]}`}
                    alt="productImage"
                  />
                </div>
              ) : (
